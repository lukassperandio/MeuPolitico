...
public class ExpenseController {
    ...
    @GetMapping("/politician/{id}/total")
    public ResponseEntity<ExpenseTotalResponse> total(@PathVariable Long id) {
        return ResponseEntity.ok(expenseService.totalByPolitician(id));
    }
